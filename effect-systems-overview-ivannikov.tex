...
%    \end{itemize}
    ...
    We can ascribe every value of type \mintinline{scala}|T| with the type of the form \mintinline{scala}|T^{cap}|, which indicates that this value is a capability and its use should be restricted.
