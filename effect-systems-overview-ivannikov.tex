...
%    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Make effect labels list unordered for reusability;
        \item Make effect labels list first-class type to support effect polymorphism for higher order functions and synonym declarations.
    \end{itemize}
