...
%    \end{itemize}
    ...
    Here we can see similarity in concepts of resources and capabilities.

    q\cite{osvald2016gentrification}\cite{brachthauser2020effects}
    ...
    q\cite{convent2020doo}\cite{tang2024modal}
