...
%    \end{itemize}
    ...
    However, many effect systems compromise some of this properties for simplicity.
    ...
    Finally, there should be a way to prove external purity of a function.
    ...
    In other words, there should be a way to express negation of effects.
    For example the following function in a Koka language catches exceptions of provided computation, propagating other effects unchanged:
